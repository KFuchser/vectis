...
def get_san_antonio_data(threshold: str) -> list[PermitRecord]:
    [cite_start]"""Fetches San Antonio permits without hardcoded valuation filters. [cite: 28, 30]"""
    ...
    try:
        ...
        for raw in raw_records:
            ...
            # REMOVED: Valuation filter. We now ingest all and filter in UI.
            p = PermitRecord(
                city="San Antonio",
